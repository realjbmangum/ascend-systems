    ...
    <>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 {...sectionHeading} className="text-3xl sm:text-4xl font-bold text-charcoal text-center mb-4">How we help</motion.h2>
          <motion.p {...sectionHeading} className="text-gray-500 text-center max-w-xl mx-auto mb-12">
      ...
      <section className="bg-surface py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 {...sectionHeading} className="text-3xl sm:text-4xl font-bold text-charcoal text-center mb-12">
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 {...sectionHeading} className="text-3xl sm:text-4xl font-bold text-charcoal text-center mb-4">Recent Work</motion.h2>
          <motion.p {...sectionHeading} className="text-gray-500 text-center max-w-xl mx-auto mb-12">
