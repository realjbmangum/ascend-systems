...
export default function ServiceCard({ icon, title, description, linkTo }: ServiceCardProps) {
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-surface-100 hover:border-orange/30">
      <div className="w-14 h-14 bg-orange-glow rounded-lg flex items-center justify-center text-orange mb-4">
        {icon}
      </div>
      <div className="border-t border-surface-100 mb-4" />
